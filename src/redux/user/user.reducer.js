...
import { checkAdmin, checkOfficer, checkDistributor, removeData } from './user.utils';
...
const userReducer = (state = INITIAL_STATE, action) => {
    switch (action.type) {
        ...
        case userActionTypes.DELETE_DISTRIBUTOR:
            return {
                ...state,
                distributor: removeData(state.distributor, action.payload)
            }
