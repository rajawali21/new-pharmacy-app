...
import { addDistributor, addSelectedUser } from '../../redux/user/user.action';
...
const ListDistributor = ({ addDistributor, distributor, toggleOverlay, stateOverlay, addSelectedUser, selectedUser }) => {
