...
import TableHeader from '../../component/table-header-request/table-header';
...
const ListDistribution = ({ stateRightDefail, toggleRightDetail, selectDistribution, addDistribution, removeDistribution, stateOverlay, toggleOverlay, distribution, addMedicine, currentUser, addSelectedUser }) => {
    ...
    const handleFinish = (e) => {
        try {
            ...
            const distDoc = firestore.collection('distribution').doc(selectedRequest.id);
            distDoc.update({
                status: '2',
            ...
            enqueueSnackbar('Data distribusi telah selesai', { variant: "success" })
        } catch (e) {
            alert(e.message);
        }
    }
        ...
        <div>
            ...
            <div className='list-distribution'>
                <div className={`left-side ${stateRightDefail && 'minified'}`}>
                    <PageHeader title='Distribution' colorSchema='#F48A16' onChange={handleSearch} noAddButton />
                    <SectionSeparator />
                ...
                <RightDetail active={stateRightDefail} bigger noPaddingTop withButton={selectedRequest.isDone ? false : 'Approve'} handleClick={handleFinish}>
